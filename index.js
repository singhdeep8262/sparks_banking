...
mongoose.connect(`mongodb+srv://sumitsingh:${process.env.DB_PASS}@banking.rd9xt.mongodb.net/banking?retryWrites=true&w=majority` , { useUnifiedTopology: true, useNewUrlParser: true, useFindAndModify: false })
    .then(() => {
